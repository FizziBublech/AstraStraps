...
def analyze_missed_calls():
    ...
    for convo in conversations:
        ...
        is_voicemail = 'voicemail' in subject.lower()
    ...
    print(f"Proportion: {proportion:.1f}% of recent tickets")
    ...
    for i, ex in enumerate(examples, 1):
        ...
        print(f"Sender: {ex.get('sender', {}).get('name')} ({ex.get('sender', {}).get('email')})")
